...
function Home() {
  ...
  const handleScrollToLetter = (letter) => {
    setSelected(letter);
    const sectionIndex = sections.findIndex(section => section.title === letter.toUpperCase());
  ...
  return (
    <SafeAreaView style={[styles.container, backgroundStyle]}>
      ...
      <Animated.SectionList
        ...
        ListEmptyComponent={<ActivityIndicator size="small" color="#0000ff" />}
        renderItem={({ item }) => (
          <TouchableOpacity 
          onPress={() => handleContact(item.login.uuid)} 
